...
namespace PersonLibrary
{
    public class PartTimeStudent : Student
    {
        ...
        public override object RandomCreate()
        {
            ...
            return new PartTimeStudent(personToReturn.ID._number, personToReturn.Surname, personToReturn.Name, personToReturn.Age,
        ...
        {
            return "id " + this.ID._number.ToString() + " " + Surname + " " + Name + " " + Age.ToString() + " лет, " + SchoolName + ", курс "
        ...
        {
            return new PartTimeStudent(this.ID._number, Surname, Name, Age, Gender, SchoolName, Year, GroupName, MajorName, WorkCardNumber);
        }
