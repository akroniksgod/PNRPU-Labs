...
namespace PersonLibrary
{
    public class Student : Schoolchild
    {
        ...
        public override object RandomCreate()
        {
            ...
            return new Student(personToReturn.ID._number, personToReturn.Surname, personToReturn.Name, personToReturn.Age,
        ...
        {
            return new Student(this.ID._number, Surname, Name, Age, Gender, SchoolName, Year, GroupName, MajorName);
        }
