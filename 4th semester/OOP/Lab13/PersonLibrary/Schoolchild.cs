...
namespace PersonLibrary
{
    public class Schoolchild : Person
    {
        ...
        { 
            get
            {
                return new Person(ID._number, Surname, Name, Age, Gender);
            }
        }
        ...
        public override object RandomCreate()
        {
            ...
            return new Schoolchild(personToReturn.ID._number, personToReturn.Surname, personToReturn.Name, personToReturn.Age,
                    personToReturn.Gender, schoolNames[rnd.Next(0, schoolNames.Length - 1)], rnd.Next(1, 12));
        }
        public override string ToString()
        {
            return "id " + this.ID._number.ToString() + " " + Surname + " " + Name + " " + Age.ToString() + " лет, " + SchoolName + ", класс " + Year.ToString();
        }
        ...
        {
            return new Schoolchild(this.ID._number, Surname, Name, Age, Gender, SchoolName, Year);
        }
        ...
        public static bool operator ==(Schoolchild obj1, Schoolchild obj2)
        {
            return obj1.ID._number == obj2.ID._number && obj1.Surname == obj2.Surname && obj1.Name == obj2.Name && obj1.Age == obj2.Age 
                && obj1.SchoolName == obj2.SchoolName && obj1.Year == obj2.Year; 
        }
        public static bool operator !=(Schoolchild obj1, Schoolchild obj2)
        {
            return !(obj1 == obj2);
